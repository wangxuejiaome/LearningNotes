...
public class ProviderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Uri bookUri = Uri.parse("content://wxj.ipclearn.contentprovider.BookProvider/book");
        ...
        Uri userUri = Uri.parse("content://wxj.ipclearn.contentprovider.BookProvider/user");
        ContentValues contentValues = new ContentValues();
        contentValues.put("_id", 3);
        contentValues.put("name", "wxj");
